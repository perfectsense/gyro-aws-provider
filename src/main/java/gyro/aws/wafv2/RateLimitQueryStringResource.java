...
public class RateLimitQueryStringResource extends Diffable implements Copyable<RateLimitQueryString> {
    ...
    @Override
    public void copyFrom(RateLimitQueryString model) {
    ...
    RateLimitQueryString toRateLimitQueryString() {
        return RateLimitQueryString.builder()
