...
public class EfsCreationInfo extends Diffable implements Copyable<CreationInfo> {
    ...
    /**
     * The POSIX group ID to apply to the root directory. Accepts values ranging from 0 to 4294967295.
     */
    ...
    /**
     * The POSIX user ID to apply to the root directory. Accepts values ranging from 0 to 4294967295.
     */
    @Range(min = 0, max = 4294967295L)
    ...
    /**
     * The POSIX permissions to apply to the root directory.
     */
