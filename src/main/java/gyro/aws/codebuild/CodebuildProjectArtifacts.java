...
public class CodebuildProjectArtifacts extends Diffable implements Copyable<ProjectArtifacts> {
    ...
    public List<ValidationError> validate(Set<String> configuredFields) {
        ...
        if (ObjectUtils.isBlank(getLocation()) && getType().equals(ArtifactsType.S3)) {
        ...
        if (ObjectUtils.isBlank(getName()) && getType().equals(ArtifactsType.S3)) {
            errors.add(new ValidationError(
                this,
                null,
        ...
        if (getEncryptionDisabled() != null && !getEncryptionDisabled() && !getType().equals(ArtifactsType.S3)) {
            errors.add(new ValidationError(
                this,
                null,
